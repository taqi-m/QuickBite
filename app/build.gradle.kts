...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            val path = properties.getProperty("signing.storeFile")
            storeFile = if (path != null) rootProject.file(path) else null
